...
# Suppress the UserWarning about starting a Matplotlib GUI outside of the main thread
...
def display_d1_cat_outlook(current_directory, outlook_data):
...
def start_gui():
    ...
    Test_Button = ctk.CTkButton(window, text='Day 1 Categorial', width=300, font=Description_Font, command=close_and_run_program)
    Test_Button.grid(row=5, column=0, columnspan=1, padx=25, sticky='ew')
...
def run_d1_cat():
    ...
    display_d1_cat_outlook(current_directory, outlook_data)
